...
const TT_DATA={
  1:{label:'Class 1',days:{Monday:['Hindi','Mathematics','English',null,'EVS','Drawing','Hindi',null,'Games','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Drawing','EVS','English',null,'Mathematics','Games'],Wednesday:['Mathematics','EVS','Hindi',null,'English','Games','Mathematics',null,'Drawing','Free Period'],Thursday:['EVS','English','Games',null,'Hindi','Mathematics','Drawing',null,'English','Free Period'],Friday:['Drawing','Mathematics','EVS',null,'Games','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'EVS','Drawing','Games',null,null,null]},teachers:{},exam:[]},
  2:{label:'Class 2',days:{Monday:['Hindi','Mathematics','English',null,'EVS','Drawing','Hindi',null,'Games','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Drawing','EVS','English',null,'Mathematics','Games'],Wednesday:['Mathematics','EVS','Hindi',null,'English','Games','Mathematics',null,'Drawing','Free Period'],Thursday:['EVS','English','Games',null,'Hindi','Mathematics','Drawing',null,'English','Free Period'],Friday:['Drawing','Mathematics','EVS',null,'Games','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'EVS','Drawing','Games',null,null,null]},teachers:{},exam:[]},
  3:{label:'Class 3',days:{Monday:['Hindi','Mathematics','English',null,'EVS','Sanskrit','Hindi',null,'Games','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Sanskrit','EVS','English',null,'Mathematics','Games'],Wednesday:['Mathematics','EVS','Hindi',null,'English','Games','Mathematics',null,'Sanskrit','Free Period'],Thursday:['EVS','English','Games',null,'Hindi','Mathematics','Sanskrit',null,'English','Free Period'],Friday:['Sanskrit','Mathematics','EVS',null,'Games','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'EVS','Sanskrit','Games',null,null,null]},teachers:{},exam:[]},
  4:{label:'Class 4',days:{Monday:['Hindi','Mathematics','English',null,'Science','Sanskrit','Hindi',null,'Social Sc.','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Sanskrit','Science','English',null,'Mathematics','Social Sc.'],Wednesday:['Mathematics','Science','Hindi',null,'English','Sports','Mathematics',null,'Sanskrit','Free Period'],Thursday:['Science','English','Sports',null,'Hindi','Mathematics','Sanskrit',null,'English','Free Period'],Friday:['Sanskrit','Mathematics','Social Sc.',null,'Sports','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'Science','Sanskrit','Social Sc.',null,null,null]},teachers:{},exam:[]},
  5:{label:'Class 5',days:{Monday:['Hindi','Mathematics','English',null,'Science','Sanskrit','Hindi',null,'Social Sc.','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Sanskrit','Science','English',null,'Mathematics','Social Sc.'],Wednesday:['Mathematics','Science','Hindi',null,'English','Sports','Mathematics',null,'Sanskrit','Free Period'],Thursday:['Science','English','Sports',null,'Hindi','Mathematics','Sanskrit',null,'English','Free Period'],Friday:['Sanskrit','Mathematics','Social Sc.',null,'Sports','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'Science','Sanskrit','Social Sc.',null,null,null]},teachers:{},exam:[]},
  6:{label:'Class 6',days:{Monday:['Hindi','Mathematics','English',null,'Science','Sanskrit','Social Sc.',null,'Sports','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Sanskrit','Science','Hindi',null,'Mathematics','Social Sc.'],Wednesday:['Mathematics','Science','Hindi',null,'English','Sports','Mathematics',null,'Sanskrit','Free Period'],Thursday:['Science','English','Sports',null,'Hindi','Mathematics','Sanskrit',null,'English','Social Sc.'],Friday:['Sanskrit','Mathematics','Social Sc.',null,'Sports','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'Science','Sanskrit','Social Sc.',null,null,null]},teachers:{},exam:[]},
  7:{label:'Class 7',days:{Monday:['Hindi','Mathematics','English',null,'Science','Sanskrit','Social Sc.',null,'Sports','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Sanskrit','Science','Hindi',null,'Mathematics','Social Sc.'],Wednesday:['Mathematics','Science','Hindi',null,'English','Sports','Mathematics',null,'Sanskrit','Free Period'],Thursday:['Science','English','Sports',null,'Hindi','Mathematics','Sanskrit',null,'English','Social Sc.'],Friday:['Sanskrit','Mathematics','Social Sc.',null,'Sports','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'Science','Sanskrit','Social Sc.',null,null,null]},teachers:{},exam:[]},
  8:{label:'Class 8',days:{Monday:['Hindi','Mathematics','English',null,'Science','Sanskrit','Social Sc.',null,'Sports','Free Period'],Tuesday:['English','Hindi','Mathematics',null,'Sanskrit','Science','Hindi',null,'Mathematics','Social Sc.'],Wednesday:['Mathematics','Science','Hindi',null,'English','Sports','Mathematics',null,'Sanskrit','Computer Lab'],Thursday:['Science','English','Sports',null,'Hindi','Mathematics','Sanskrit',null,'English','Social Sc.'],Friday:['Sanskrit','Mathematics','Social Sc.',null,'Sports','Hindi','English',null,'Mathematics','Free Period'],Saturday:['Hindi','English','Mathematics',null,'Science','Sanskrit','Social Sc.',null,null,null]},teachers:{},exam:[]},
  9:{label:'Class 9',days:{Monday:['Hindi','Mathematics','English',null,'Science','Social Sc.','Hindi',null,'Sanskrit','Free Period'],Tuesday:['Science','Hindi','Mathematics',null,'Social Sc.','Sanskrit','English',null,'Mathematics','Science'],Wednesday:['English','Science','Social Sc.',null,'Mathematics','Hindi','Sanskrit',null,'Computer Lab','Sports'],Thursday:['Social Sc.','English','Hindi',null,'Sanskrit','Mathematics','Science',null,'English','Mathematics'],Friday:['Mathematics','Sanskrit','English',null,'Hindi','Science','Social Sc.',null,'Sports','Free Period'],Saturday:['Sanskrit','Social Sc.','Mathematics',null,'Science','English','Hindi',null,null,null]},teachers:{Mathematics:'Mr. A. Kumar',Science:'Mr. V. Yadav','Social Sc.':'Mrs. N. Singh',English:'Mr. D. Sharma',Hindi:'Mrs. K. Mishra',Sanskrit:'Mr. B. Tiwari'},exam:[]},
  10:{label:'Class 10',days:{Monday:['Mathematics','Science','Social Sc.',null,'English','Hindi','Mathematics',null,'Sanskrit','Free Period'],Tuesday:['Hindi','Mathematics','English',null,'Science','Social Sc.','Hindi',null,'Mathematics','Sanskrit'],Wednesday:['Science','Hindi','Mathematics',null,'Sanskrit','English','Social Sc.',null,'Computer Lab','Sports'],Thursday:['English','Social Sc.','Hindi',null,'Mathematics','Science','Sanskrit',null,'Science','Mathematics'],Friday:['Sanskrit','Mathematics','Social Sc.',null,'Hindi','Science','English',null,'Sports','Free Period'],Saturday:['Science','English','Hindi',null,'Mathematics','Sanskrit','Social Sc.',null,null,null]},teachers:{Mathematics:'Mr. A. Kumar',Science:'Mr. V. Yadav','Social Sc.':'Mrs. N. Singh',English:'Mr. D. Sharma',Hindi:'Mrs. K. Mishra',Sanskrit:'Mr. B. Tiwari'},exam:[{date:'10 Mar 2025',day:'Monday',sub:'Mathematics',time:'9:00 AM – 12:00 PM',venue:'Hall B'},{date:'12 Mar 2025',day:'Wednesday',sub:'Science',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'14 Mar 2025',day:'Friday',sub:'Social Sc.',time:'9:00 AM – 12:00 PM',venue:'Hall C'},{date:'17 Mar 2025',day:'Monday',sub:'English',time:'9:00 AM – 12:00 PM',venue:'Hall B'},{date:'19 Mar 2025',day:'Wednesday',sub:'Hindi',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'21 Mar 2025',day:'Friday',sub:'Sanskrit',time:'9:00 AM – 12:00 PM',venue:'Hall C'}]},
  11:{label:'Class 11',days:{Monday:['Physics','Chemistry','Mathematics',null,'Biology','English','Physics Lab',null,'Hindi','Free Period'],Tuesday:['Mathematics','Physics','Chemistry',null,'English','Hindi','Biology Lab',null,'Mathematics','Chemistry'],Wednesday:['Biology','Mathematics','English',null,'Physics','Chemistry','Hindi',null,'Computer Lab','Sports'],Thursday:['Chemistry','Biology','Hindi',null,'Mathematics','Physics','English',null,'Biology','Mathematics'],Friday:['English','Hindi','Physics',null,'Chemistry','Mathematics','Biology',null,'Sports','Free Period'],Saturday:['Mathematics','Chemistry','Physics',null,'Hindi','English','Biology',null,null,null]},teachers:{Physics:'Mr. R. Singh',Chemistry:'Mrs. P. Gupta',Mathematics:'Mr. A. Kumar',Biology:'Mrs. S. Verma',English:'Mr. D. Sharma',Hindi:'Mrs. K. Mishra'},exam:[{date:'10 Mar 2025',day:'Monday',sub:'Physics',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'12 Mar 2025',day:'Wednesday',sub:'Chemistry',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'14 Mar 2025',day:'Friday',sub:'Mathematics',time:'9:00 AM – 12:00 PM',venue:'Hall B'},{date:'17 Mar 2025',day:'Monday',sub:'Biology',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'19 Mar 2025',day:'Wednesday',sub:'English',time:'9:00 AM – 12:00 PM',venue:'Hall B'},{date:'21 Mar 2025',day:'Friday',sub:'Hindi',time:'9:00 AM – 12:00 PM',venue:'Hall A'}]},
  12:{label:'Class 12',days:{Monday:['Chemistry','Physics','Biology',null,'Mathematics','English','Chemistry Lab',null,'Hindi','Free Period'],Tuesday:['Physics','Mathematics','Chemistry',null,'Hindi','Biology','Physics Lab',null,'English','Mathematics'],Wednesday:['Mathematics','Chemistry','Hindi',null,'Biology','Physics','English',null,'Computer Lab','Sports'],Thursday:['Biology','English','Physics',null,'Chemistry','Mathematics','Hindi',null,'Biology Lab','Mathematics'],Friday:['Hindi','Biology','Mathematics',null,'English','Chemistry','Physics',null,'Sports','Free Period'],Saturday:['Physics','English','Chemistry',null,'Mathematics','Hindi','Biology',null,null,null]},teachers:{Physics:'Mr. R. Singh',Chemistry:'Mrs. P. Gupta',Mathematics:'Mr. A. Kumar',Biology:'Mrs. S. Verma',English:'Mrs. T. Arora',Hindi:'Mrs. K. Mishra'},exam:[{date:'11 Mar 2025',day:'Tuesday',sub:'Physics',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'13 Mar 2025',day:'Thursday',sub:'Chemistry',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'15 Mar 2025',day:'Saturday',sub:'Mathematics',time:'9:00 AM – 12:00 PM',venue:'Hall B'},{date:'18 Mar 2025',day:'Tuesday',sub:'Biology',time:'9:00 AM – 12:00 PM',venue:'Hall A'},{date:'20 Mar 2025',day:'Thursday',sub:'English',time:'9:00 AM – 12:00 PM',venue:'Hall B'},{date:'22 Mar 2025',day:'Saturday',sub:'Hindi',time:'9:00 AM – 12:00 PM',venue:'Hall A'}]},
};
...
<div class="footer">Downloaded on ${new Date().toLocaleDateString('en-IN',{dateStyle:'long'})} · RKPH Inter College</div>
  ...
  triggerDownload(`Timetable_${tt.label.replace(/\s/g,'_')}.html`, html);
...
function populatePortal(st){
  ...
  document.getElementById('ppcTags').innerHTML     = `<span>${st.class}</span><span>${st.stream||'General'}</span><span>Sec ${st.section||'A'}</span>${st.session?`<span style="opacity:.7;font-size:.78em">${st.session}</span>`:''}`;
...
function renderAcademicTimeline(roll){
  ...
  const passedYears = hist.filter(h=>h.status==='Passed').length;
  if(chip) chip.textContent = `${passedYears} Year${passedYears!==1?'s':''} Completed`;

  tl.innerHTML = hist.map((h,i)=>{
    const isLast = i===hist.length-1;
    const isPassed = h.status==='Passed';
    const isInProgress = h.status==='In Progress';
    const dotColor = isPassed?'var(--teal)':isInProgress?'var(--amber)':'var(--muted)';
    const gradeColor = h.pct>=75?'var(--teal)':h.pct>=50?'var(--amber)':'var(--rose)';
    return `<div class="atl-item${isLast?' atl-current':''}">
      <div class="atl-left">
        <div class="atl-dot" style="background:${dotColor}">
          <i class="fas fa-${isPassed?'check':isInProgress?'circle-notch fa-spin':'arrow-right'}" style="font-size:.55rem;color:#fff"></i>
        </div>
        ${!isLast?'<div class="atl-line"></div>':''}
      </div>
      <div class="atl-body">
        <div class="atl-head">
          <span class="atl-cls">${h.class}</span>
          <span class="atl-session">${h.session}</span>
          <span class="atl-status" style="color:${dotColor}">${h.status}</span>
        </div>
        <div class="atl-sub">${h.stream||'General'}</div>
        ${isPassed?`<div class="atl-grade" style="color:${gradeColor}">Grade ${h.grade} &nbsp;·&nbsp; ${h.pct}%</div>`:''}
        ${isInProgress?`<div class="atl-grade" style="color:var(--amber)"><i class="fas fa-book-open" style="font-size:.75rem"></i> Currently enrolled</div>`:''}
      </div>
    </div>`;
  }).join('');
}
...
function renderExamTT(){
  ...
  if(!tt.exam?.length) html+=`<tr><td colspan="5" style="text-align:center;opacity:.45;padding:1.5rem">No exam schedule added yet.</td></tr>`;
